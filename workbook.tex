...
\begin{exercise}(Exercise 3.8 from course notes)
    ...
    \begin{proof}
        ...
        \begin{proof}
        	 \fixme{Rivedere questa dimostrazione, copiare dal foglio perché era stata fatta diversamente (con qualche errore)}
	...
	\begin{enumerate}
		...
		\prooftree
		  \prooftree
		    \nohyp
		  \justifies
		    fields(\texttt{Pair}) = \tilde{f} \quad \texttt{snd} \in \tilde{f}
		  \endprooftree
		\justifies
